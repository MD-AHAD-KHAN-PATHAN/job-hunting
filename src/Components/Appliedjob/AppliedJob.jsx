...
const AppliedJob = ({ job }) => {
    ...
    return (
        <div className="grid grid-cols-3 items-center border p-6 rounded-lg leading-10 mb-6">
            <div>
                <img src={logo} alt="" />
            </div>
            <div>
                <h2 className="text-2xl font-semibold mt-8">{job_title}</h2>
                <p className="font-bold"> {company_name} </p>
                <div>
                    <button className="btn mr-6">{remote_or_onsite}</button>
